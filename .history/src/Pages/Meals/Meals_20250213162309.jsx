      ...
      <div className="mt-16 grid sm:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-8 gap-y-28 justify-center mb-3 ">
        {
          products.map((product,index)=>{
            ...
            <div className="">
              <img  src={product.strCategoryThumb} alt="" className='group-hover:animate-spin-slow transition-transforml duration-300 rounded-full w-40 h-40 shadow-lg -mt-20'/>
            </div>
