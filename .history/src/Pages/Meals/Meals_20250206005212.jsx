  ...
  return (
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="hidden sm:flex sm:space-x-4">
        <NavLink>
        <Button className="px-4 py-2 border bg-transparent border-gray-400 text-gray-700 rounded-full hover:scale-105 hover:shadow-md hover:text-black font-semibold font">
          All
        </Button>
        </NavLink>
        <NavLink>
