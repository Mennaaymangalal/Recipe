...
export default function Meals() {
  ...
  return (
    <>
      ...
      {/* Categories Layout */}
      <div className="mt-16 grid sm:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-8 gap-y-28 justify-center mb-3  hover:scale-x-110">
        {
          products.map((product,index)=>{
            return <div key={index} className=" group w-fit px-10 py-4 shadow-md bg-white rounded-3xl text-center">
            <div className="">
