...
export default function Meals() {
  ...
  return (
    <>
      ...
      {/* Categories Layout */}
      <div className="mt-16 grid grid-cols-4 gap-8 gap-y-28 justify-center">
        <div className=" w-fit px-10 py-4 bg-white rounded-3xl">
          ...
          <div className="flex flex-wrap flex-col justify-center align-middle ">
            ...
            <Button className='px-3 py-8 font-pacifico mb-6 bg-green-500 text-white text-lg font-bold rounded-full mx-4'>
              <a href="" className='px-2'>View Recipe</a>
            </Button>
          </div>
        </div>

        <div className=" w-fit px-12 py-4 bg-white rounded-3xl">
          <div className="">
            <img  src={img} alt="" className='rounded-full w-40 h-40 shadow-lg -mt-20'/>
          </div>
          <div className="flex flex-wrap flex-col justify-center align-middle ">
            <h3 className='text-center pt-6 font-bold text-2xl font-pacifico'>sushi</h3>
            <h5 className='text-center pb-4 font-semibold text-xl font-pacifico'>Japanese</h5>
            <Button className='px-4 font-pacifico mb-6 bg-green-500 text-white text-lg font-bold rounded-full mx-4'>
