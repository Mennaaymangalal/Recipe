        ...
        <div className="hidden md:grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-9 gap-5 justify-items-center">
          {categories.map((category, index) => (
            <NavLink key={index} to={``}>
              <Button className="w-full px-4 py-2 border bg-transparent border-gray-400 text-gray-700 rounded-full hover:scale-105 hover:shadow-md hover:text-black font-semibold font-pacifico text-center text- ">
                {category.label}
              </Button>
            </NavLink>
          ))}
