  ...
  return (
    <>
      ...
      <div className="mt-16 grid sm:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-8 gap-y-28 justify-center">
        ...
        <div className=" w-fit px-9 py-3 shadow-md bg-white rounded-3xl text-center  mb-5">
          <div className="">
            <img  src={img} alt="" className='rounded-full w-40 h-40 shadow-lg -mt-20'/>
          </div>
          <div className="flex flex-col items-center ">
        ...
        <div className=" w-fit px-9 py-4 shadow-md bg-white rounded-3xl text-center mb-5">
          <div className="">
            <img  src={img} alt="" className='rounded-full w-40 h-40 shadow-lg -mt-20'/>
          </div>
          <div className="flex flex-col items-center ">
