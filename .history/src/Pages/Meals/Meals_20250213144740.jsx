...
export default function Meals() {
  ...
  return (
    <>
        {/* Button Layout */}
      <div className="container mx-auto p-4 bg-g">
      ...
      {/* Categories Layout */}
      <div className="mt-16">
        <div className=" w-fit px-12 py-4 bg-gray-200 rounded-3xl">
          <div className="">
            <img  src={img} alt="" className='rounded-full w-40 h-40 shadow-lg -mt-20'/>
          </div>
          <div className="flex flex-col justify-center align-middle ">
            <h3 className='text-center pt-4 font-bold text-2xl font-pacifico'>sushi</h3>
            <h5 className='text-center pb-4 font-semibold text-xl font-pacifico'>Japanese</h5>
            <Button className=' font-pacifico mb-6 bg-green-500 text-white text-lg font-bold rounded-full mx-4'>
