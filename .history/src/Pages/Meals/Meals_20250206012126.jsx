        ...
        <div className="hidden sm:flex sm:space-x-4">
          {categories.map((category,index) => (
            <NavLink key={index} to={``}>
              <Button className="overflow-y-auto px-4 py-2 border bg-transparent border-gray-400 text-gray-700 rounded-full hover:scale-105 hover:shadow-md hover:text-black font-semibold font-pacifico">
                {category.label}
              </Button>
            </NavLink>
          ))}
