        ...
        <div className="hidden md:flex sm:space-x-4">
          {categories.map((category,index) => (
            <NavLink key={index} to={``}>
              <Button className="px-4 py-2 border bg-transparent border-gray-400 text-gray-700 rounded-full hover:scale-105 hover:shadow-md hover:text-black font-semibold font-pacifico text">
                {category.label}
              </Button>
            </NavLink>
          ))}
