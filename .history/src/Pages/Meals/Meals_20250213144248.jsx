      ...
      <div className="">
        <div className=" w-fit px-6 bg-gray-200">
          ...
          <div className="flex flex-col justify-center align-middle">
            <h3 className='text-center pt-4 font-bold text-xl font-pacifico'>sushi</h3>
            <h5 className='text-center pb-4 font-semibold text-lg font-pacifico'>Japanese</h5>
            <Button className=' font-pacifico px-6 bg-green-500 text-white text-lg font-bold rounded-full mx-4'>
