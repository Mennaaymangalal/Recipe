...
export default function Meals() {
  ...
  return (
    <>
      ...
      {/* Categories Layout */}
      <div className="mt-16 grid sm:grid-cols-2 px-10  lg:grid-cols-3 xl:grid-cols-4 gap-8 gap-y-28 justify-center mb-3 ">
        {
          products.map((product,index)=>{
            return <div key={index} className=" group w-fit  py-4 shadow-md bg-white rounded-3xl text-center hover:scale-x-110">
            <div className="">
              <img  src={product.strCategoryThumb} alt="" className='group-hover:rotate-360 transition-all duration-500 rounded-full w-40 h-40 shadow-lg -mt-20'/>
            </div>
