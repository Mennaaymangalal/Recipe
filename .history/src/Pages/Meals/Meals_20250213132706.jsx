  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="p-4 space-y-4">
        ...
        {/* For Larger Screens - Vertical Column Layout */}
        <div className="hidden md:flex flex-col items-center gap-4">
          {categories.map((category, index) => (
            <NavLink key={index} to={``}>
              <Button className="w-full max-w-sm px-4 py-2 border bg-transparent border-gray-400 text-gray-700 rounded-full hover:scale-105 hover:shadow-md hover:text-black font-semibold font-pacifico text-lg text-center">
                {category.label}
              </Button>
            </NavLink>
          ))}
