     ...
     <NavbarContent>
      ...
      <div className="flex flex-col gap-4 items-center h-full">
      {
        menuItems.map((item , index)=>{
          ...
          >     
          <Button className='bg border border-gray-300 px-24 py-2 h-full w-full rounded-lg active:bg-orangeHighlight hover:bg-orangeHighlight focus:bg-orangeHighlight transition-all duration-200'>
          {item}     
          </Button>  
          </NavLink>
        </NavbarItem>
