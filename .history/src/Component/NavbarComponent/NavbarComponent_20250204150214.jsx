     ...
     <NavbarContent>
      ...
      <div className="flex flex-col gap-4 items-center h-full">
      {
        menuItems.map((item , index)=>{
          ...
          className={({ isActive }) =>
            isActive
              ? "bg-orangeHighlight text-white w-full h-full flex items-center justify-start rounded-lg"
              : "bg-transparent text-black hover:bg-orangeHighlight hover:text-white w-full h-full flex items-center justify-start rounded-lg"
          }
